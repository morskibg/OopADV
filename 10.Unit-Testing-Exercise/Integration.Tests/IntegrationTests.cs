...
public class IntegrationTests
{
    ...
    public void AddChildShouldAssignAChildcategoryToTheParent()
    {
        ...
        // Assert
        Assert.AreEqual(
            parentCategory.ChildCategories.Count,
            1,
    ...
    public void AddMoreThanOneCategoryShouldSaveAllOfThem(int numberOfCategories)
    {
        ...
        // Act
        for (var i = 0; i < numberOfCategories; i++) this.categoryController.AddCategory($"{categoryName} - {i}");
    ...
    public void AddMultipleCategoriesAtOneShouldSaveAllOfThem(int numberOfCategories)
    {
        ...
        for (var i = 0; i < categoryNames.Length; i++) categoryNames[i] = $"Test - {i}";
    ...
    {
        // Assert
        Assert.Throws<ArgumentException>(() => this.categoryController.AddCategory(string.Empty));
    }
    ...
    public void RemoveCategoryShouldAssignAllOfItsUsersToItsParent()
    {
        ...
        Assert.AreEqual(
            1,
            this.categories.First().Users.Count(),
    ...
    public void RemoveCategoryShouldMoveChildCategoriesToItsParentOne()
    {
        ...
        // Assert
        Assert.AreEqual(
            this.categories.First().ChildCategories.Count,
            1,
    ...
    public void RemoveCategoryWithCollectionOfNameShouldDeleteThem(int numberOfDeletions)
    {
        ...
        for (var i = 0; i < deletionNames.Length; i++) deletionNames[i] = string.Format(categoryname, i);
        ...
        // Assert
        Assert.AreEqual(
            numberOfCategories - deletionNames.Length,
            this.categories.Count,
